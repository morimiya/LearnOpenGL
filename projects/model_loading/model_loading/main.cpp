...
int main()
{
	...
	// -------------------------
	CShader ourShader("../shaders/shader.vs", "../shaders/shader.fs");

	// load models
	// -----------
	//CModel ourModel(FileSystem::getPath("resources/objects/nanosuit/nanosuit.obj"));
	CModel ourModel("../../res/nanosuit/nanosuit.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.setFloat("spotLight.cutOff", glm::cos(glm::radians(8.5f)));
