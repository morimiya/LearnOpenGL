...
int session4()
{
	...
	CShader cubeShader("../shaders/lightingmaps/cube.vs", "../shaders/lightingmaps/cube.fs");
	CShader lampShader("../shaders/lightingmaps/lamp.vs", "../shaders/lightingmaps/lamp.fs");
