...
int session5()
{
	...
	CShader cubeShader("../shaders/lightcasters/cube.vs", "../shaders/lightcasters/cube.fs");
	CShader lampShader("../shaders/lightcasters/lamp.vs", "../shaders/lightcasters/lamp.fs");
