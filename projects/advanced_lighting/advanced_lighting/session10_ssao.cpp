...
// camera
static Camera camera(glm::vec3(3.0f, 1.0f, 6.0f));
...
int session10()
{
	...
	// -------------------------
	CShader gBufferShader("../shaders/ssao/gbuffer.vs", "../shaders/ssao/gbuffer.fs");
	CShader lightShader("../shaders/ssao/light.vs", "../shaders/ssao/light.fs");
	CShader ssaoShader("../shaders/ssao/ssao.vs", "../shaders/ssao/ssao.fs");
	CShader ssaoBlurShader("../shaders/ssao/ssaoblur.vs", "../shaders/ssao/ssaoblur.fs");

	// models
	CModel objModel("../../res/nanosuit/nanosuit.obj");
	...
	if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
		std::cout << "ssaoblur not complete!" << std::endl;
	glBindFramebuffer(GL_FRAMEBUFFER, 0);
