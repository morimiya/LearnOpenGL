...
int session9()
{
	...
	// -------------------------
	CShader gBufferShader("../shaders/deferred_shading/gbuffer.vs", "../shaders/deferred_shading/gbuffer.fs");
	CShader lightShader("../shaders/deferred_shading/light.vs", "../shaders/deferred_shading/light.fs");
	CShader lightBoxShader("../shaders/deferred_shading/lightbox.vs", "../shaders/deferred_shading/lightbox.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightBoxShader.setMatrix4fv("view", view);
		for (size_t i = 0; i < lightPositions.size(); ++i) {
			model = glm::mat4(1.0f);
